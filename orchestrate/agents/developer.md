...
1. Read `<autodev-dir>/4-design-final.md` for the final design
2. Implement the design
3. Write unit tests and verify they pass

## Bug Fix Mode (unfixed integrations-error files exist)
1. Read `<autodev-dir>/4-design-final.md` for context
...
6. Rename each fixed error file: `integrations-error-<N>.md` -> `integrations-error-<N>-DONE.md`
