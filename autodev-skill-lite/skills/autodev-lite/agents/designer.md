...
3. Design the technical solution based on the existing codebase architecture, tech stack, and conventions
   - Keep the design simple - avoid over-engineering
4. Think deeply about the design - use extended thinking for complex decisions
5. Create design `<dev-session-dir>/2-design.md` with:
