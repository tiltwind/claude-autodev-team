...
When invoked:
1. Read the raw requirement from `<autodev-session-dir>/0-requirement-raw.md`
...
Create `<autodev-session-dir>/1-requirement-final.md` with structured requirements including:
- Overview / Summary
